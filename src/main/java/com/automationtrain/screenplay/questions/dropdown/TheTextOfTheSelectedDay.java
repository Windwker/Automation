...
public class TheTextOfTheSelectedDay implements Question<String> {
    @Override
    public String answeredBy(Actor theActor) {
        return Text.of(Label.DAY_SELECTED).viewedBy(theActor).asString();
    }

    public static Question<String> is(){
        return new TheTextOfTheSelectedDay();
    }
}
